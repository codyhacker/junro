  ...
  return (
    <div className="trip-actions">
      ...
      <div className="trip-actions-row">
        {hasDays && (
          <a className="trip-action" href={`${base}?view=itinerary`}>
            📋 Itinerary
          </a>
        )}
        {hasDays && (
          <a className="trip-action" href={`${base}?view=today`}>
            📱 Today
          </a>
        )}
        {hasDays && (
          <button className="trip-action" onClick={() => downloadTripIcs(trip)}>
            📅 .ics
          </button>
        )}
        <button className="trip-action" onClick={() => downloadTripJson(trip)}>
          ⬇ JSON
        </button>
        <button className="trip-action" onClick={() => fileRef.current?.click()}>
          ⬆ Import
        </button>
