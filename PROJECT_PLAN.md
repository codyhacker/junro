...
✓ *Verify:* 5-day trip, 2 hotels; each day resolves the correct lodging; assigning a place recolors its pin; shrinking the trip returns orphaned stops to the scrapbook with confirmation.
